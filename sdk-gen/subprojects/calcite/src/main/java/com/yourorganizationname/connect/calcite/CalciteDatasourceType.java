...
{
    /**
     * An instance of the custom Apache Calcite data source type.
     */
    public static final CalciteDatasourceType INSTANCE = new CalciteDatasourceType();

    /**
     * The unique identifier name of the data source type.
     */
    public static final String DATASOURCE_TYPE_NAME = "calcite";
    private static final String DATASOURCE_TYPE_LABEL = "calcite";
    private static final String DATASOURCE_TYPE_DESCRIPTION = "calcite (SDK)";

    /**
     * Defines a custom data source type for Apache Calcite.
     */
    public CalciteDatasourceType()
    {
        super();
